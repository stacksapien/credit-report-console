...
const Notifications = [
{
  id: 2,
  text: 'Loan Approved',
  subText: 'Your loan approved (Rs. 12,000) for Loan ID #2342',
...
},
{
  ...
  subText: 'Hi, Your loan request of ID #1234 Declined',
  icon: 'uil uil-comment-message',
  bgColor: 'danger'
}, {
  id: 4,
  text: 'EMI Pending for Loan ID #3242',
  subText: '1 day ago',
          ...
          <Container fluid>
            ...
            <Link to="/" className="navbar-brand mr-0 mr-md-2 logo">
              <span className="logo-lg">
                ...
                <span className="d-inline h5 ml-2 text-logo"></span>
              </span>
            ...
            <ul className="navbar-nav flex-row ml-auto d-flex list-unstyled topnav-menu float-right mb-0">
              <li style={{alignSelf : "center"}} className="d-none d-sm-block">
                
                <span style={{fontWeight : "700"}}><i className="uil uil-wallet"></i> 20 Rs</span>
