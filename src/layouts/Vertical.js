...
class VerticalLayout extends Component {
    ...
    render() {
        ...
        const centerLayoutPage = layoutConstants.CENTER_LAYOUT_PAGE_URLS.includes(this.props.match.url);

        const contentPageCss = centerLayoutPage ? "content-page center-content-page" : "content-page"; 
