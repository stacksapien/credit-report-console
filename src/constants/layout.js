...
export const CENTER_LAYOUT_PAGE_URLS = ["/kyc-details"];

export const STATUS_IN_PROCESS = 'In Process';
export const STATUS_APPROVED = 'Approved';
export const STATUS_UNDER_VERIFICATION = 'Under Verification';
export const STATUS_DECLINED = 'Declined';

export const STATUS_TYPES = ['Approved', 'In Process', 'Under Verification', 'Declined'];
export const STATUS_TYPES_APPROVED_DECLINED = ['Approved', 'Declined'];