                ...
                <Row>
                    <Col>
                        <div className="text-center mt-3">
                            ...
                            <h6 className="text-muted font-weight-normal mt-2 mb-0">Borrower</h6>
                            <h6 className="text-muted font-weight-normal mt-1 mb-4">ABC, IN</h6>
                            ...
                            <button type="button" className="btn btn-primary btn-sm mr-1">Edit / Complete</button>
