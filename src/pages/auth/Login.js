...
import { KYC_STATUS_PENDING } from './../../constants/utility';
...
class Login extends Component {
    ...
    renderRedirectToRoot = () => {
        ...
        if (isAuthTokenValid) {
            console.log(this.props.user.kycStatus);
            return <Redirect to='/' />
        }
    }
                                        ...
                                        <Row>
                                                ...
                                                <AvForm onValidSubmit={this.handleValidSubmit} className="authentication-form">
                                                    <AvGroup className="">
                                                        ...
                                                        <InputGroup>
                                                            ...
                                                            <AvInput type="email" name="email_address" autoComplete="false" id="email_address" placeholder="Enter your email" value={this.state.username} required />
                                                        </InputGroup>
                                                    ...
                                                    <AvGroup className="mb-3">
                                                        ...
                                                        <InputGroup>
                                                            ...
                                                            <AvInput type="password" name="password" id="password" autoComplete="false" placeholder="Enter your password" value={this.state.password} required />
                                                        </InputGroup>
                                                        <AvFeedback>This field is invalid</AvFeedback>
                                                    </AvGroup>
                                            ...
                                            <div className="auth-page-sidebar">                                                   
                                                    ...
                                                    <p className="font-size-24 font-weight-bold text-white mb-1">I simply love it!</p>
                                                        <p className="lead">"Information related to Credit Report!"</p>
                                                        <p>- Admin User</p>
                                                    </div>
                                                </div>
                                            </Col>
