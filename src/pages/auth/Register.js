                                                ...
                                                <AvForm onValidSubmit={this.handleValidSubmit} className="authentication-form">
                                                    <AvGroup className="">
                                                        ...
                                                        <InputGroup>
                                                            ...
                                                            <AvInput type="text" name="fullname" autocomplete="false" id="fullname" placeholder="Your full name" required />
                                                        </InputGroup>
                                                    ...
                                                    <AvGroup className="">
                                                        ...
                                                        <InputGroup>
                                                            ...
                                                            <AvInput type="email" name="email" id="email" autocomplete="false" placeholder="Enter your email" required />
                                                        </InputGroup>
                                                    ...
                                                    <AvGroup className="mb-3">
                                                        ...
                                                        <InputGroup>
                                                            ...
                                                            <AvInput type="password" name="password" id="password" placeholder="Enter your password" autocomplete="false" required />
                                                        </InputGroup>
                                                        <AvFeedback>This field is invalid</AvFeedback>
                                                    </AvGroup>

                                                    <AvGroup check className="mb-4">
                                                        <CustomInput type="checkbox" id="terms" defaultChecked="true"  required className="pl-1" label="I accept Terms and Conditions" />
                                                    </AvGroup>
