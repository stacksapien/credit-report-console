...
import { ChevronDown, Mail, Printer, File, Users, Image, ShoppingBag, DollarSign, Calendar, Check, CheckCircle, Smile, Star, BarChart, BarChart2 } from 'react-feather';
    ...
    return (
        <Card>
            <CardBody className="pb-0">
                ...
                <h5 className="card-title mb-0 header-title">Commission Report</h5>
                ...
                <div className="">
                    ...
                    <Row>
                        <Col xl={3}>
                            <OverviewWidget
                                items={[
                                    { title: '★★★★★', description: 'Rating', icon: Smile },
                                    { title: 'Rs. 15000', description: 'Last Loan Amount Approved', icon: Calendar },
                                    { title: '8%', description: 'Commission Rate', icon: BarChart2 },
                                ]}></OverviewWidget>
                        </Col>
